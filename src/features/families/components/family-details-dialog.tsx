          ...
          <div className="mt-4 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {family.malesCount !== undefined &&
                  family.femalesCount !== undefined && (
                    <div className="text-xs text-gray-400 mt-1 flex gap-2">
                      <span>ذكر: {family.malesCount}</span>
                      <span>أنثى: {family.femalesCount}</span>
                    </div>
                  )}
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-xl flex flex-col items-center justify-center text-center">
                ...
                <span className="text-sm text-gray-500">موقع السكن</span>
                <span className="font-bold text-green-700">{family.camp}</span>
                <span className="text-xs text-green-600">
                  خيمة: {family.tentNumber}
                </span>
              </div>
            ...
            <div className="bg-gray-50 p-4 rounded-xl space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {family.backupPhone && (
                  <div className="flex items-center gap-3">
                    <Phone className="h-4 w-4 text-gray-500" />
                    <span className="text-sm text-gray-600">رقم بديل:</span>
                    <span className="text-sm font-medium" dir="ltr">
                      {family.backupPhone}
                    </span>
                  </div>
            ...
            {family.notes && (
              <div className="bg-yellow-50 p-4 rounded-xl">
                <h3 className="font-semibold text-yellow-800 mb-2">ملاحظات</h3>
