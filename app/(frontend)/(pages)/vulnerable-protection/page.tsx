...
export default function Page() {
  ...
  // Using "goals" pageType from API (backend naming)
  const { data: pageData, isLoading } = usePage("goals");
  const locale = (
  ...
  const title =
    typeof titleData === "object" && titleData
      ? titleData[locale] || titleData.ar || "حماية الفئات الهشة"
      : titleData || "حماية الفئات الهشة";
